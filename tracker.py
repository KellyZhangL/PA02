...
def process_choice(choice):
    ...
    #Author: Zheyu Yan
        ...
        try:
            date_input = input("Please input date(YYYY): ")
            validate(date_input, DateFormat.YEAR)
            cats = category.select_by_year(date_input)
            print_categories(cats)
        except ValueError as error:
            print(str(error))
    ...
    #Author: Zheyu Yan
        ...
        result = category.select_by_category(cat)
